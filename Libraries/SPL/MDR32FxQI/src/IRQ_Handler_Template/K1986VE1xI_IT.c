/**
  ...
  * @version V2.1.0i
  * @date    24/07/2024
  * @brief   Main Interrupt Service Routines for MCU K1986VE1xI.
  ******************************************************************************
  * <br><br>
  *
...
* Description    : This function handles ARINC429T4 global interrupt request.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
