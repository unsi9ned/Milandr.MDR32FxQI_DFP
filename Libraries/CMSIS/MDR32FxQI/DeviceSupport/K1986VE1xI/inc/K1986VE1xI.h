...
#ifndef __K1986VE1xI_H
#define __K1986VE1xI_H
...
/** @addtogroup K1986VE1xI_Peripheral K1986VE1xI Peripheral
  * @{
  */
...
/**
  * @brief K1986VE1xI Interrupt Number Definition
  */
...
#define EEPROM_FACTORY_DATA_BASE ((uint32_t)0x00000F80)
...
/** @addtogroup __K1986VE1xI_Memory_Units K1986VE1xI Memory Units
  * @{
  */

/** @defgroup K1986VE1xI_Memory_EEPROM_FACTORY_DATA EEPROM FACTORY_DATA
  * @{
  */

/** @defgroup K1986VE1xI_Memory_EEPROM_FACTORY_DATA_Addresses_for_Register_Access Addresses for Register Access
  * @{
  */
...
/** @} */ /* End of group K1986VE1xI_Memory_EEPROM_FACTORY_DATA_Addresses_for_Register_Access */

/** @defgroup K1986VE1xI_Memory_EEPROM_FACTORY_DATA_Defines Defines
  * @{
  */
...
/** @} */ /* End of group K1986VE1xI_Memory_EEPROM_FACTORY_DATA_Defines */

/** @} */ /* End of group K1986VE1xI_Memory_EEPROM_FACTORY_DATA */

/** @} */ /* End of group __K1986VE1xI_Memory_Units */

/** @defgroup __K1986VE1xI_Peripheral_Units K1986VE1xI Peripheral Units
  * @{
  */

/** @defgroup K1986VE1xI_Periph_CAN CAN
  * @{
  */

/** @defgroup K1986VE1xI_CAN_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_CAN_Data_Structures */

/** @defgroup K1986VE1xI_Periph_CAN_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_CAN_CONTROL	CAN CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_STATUS	CAN STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_BITTMNG	CAN BITTMNG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_INT_EN	CAN INT EN
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_RXID	CAN RXID
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_RXDLC	CAN RXDLC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_RXDATAL	CAN RXDATAL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_RXDATAH	CAN RXDATAH
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_CAN_BUF_CON	CAN BUF CON
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_CAN_Defines Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_CAN CAN */

/** @defgroup K1986VE1xI_Periph_USB USB
  * @{
  */

/** @defgroup K1986VE1xI_Periph_USB_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_USB_Data_Structures */

/** @defgroup K1986VE1xI_Periph_USB_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_USB_HTXC	USB HTXC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HTXLC	USB HTXLC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HIS	USB HIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HIM	USB HIM
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HRXS	USB HRXS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_SEP_CTRL	USB SEP CTRL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_SEP_STS	USB SEP STS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_SC	USB SC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_SIS	USB SIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_SIM	USB SIM
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HSCR	USB HSCR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_USB_HSVR	USB HSVR
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_USB_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_USB */


/** @defgroup K1986VE1xI_Periph_EEPROM EEPROM
  * @{
  */

/** @defgroup K1986VE1xI_Periph_EEPROM_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_EEPROM_Data_Structures */

/** @defgroup K1986VE1xI_Periph_EEPROM_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_EEPROM_CMD	EEPROM CMD
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_EEPROM_Defines Defines */

/** @}*/ /* End of group K1986VE1xI_Periph_EEPROM EEPROM */

/** @defgroup K1986VE1xI_Periph_RST_CLK RST_CLK
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_RST_CLK_Data_Structures Data Structures
  * @{
  */
...
typedef struct {
  ...
  __IO uint32_t DMA_DONE_STICK;
#endif /* #if defined(USE_K1986VE1xI) && !defined(USE_MDR32F1QI) */
} MDR_RST_CLK_TypeDef;

/** @} */ /* End of group Periph_RST_CLK_Data_Structures */

/** @defgroup __K1986VE1xI_Periph_RST_CLK_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_RST_CLK_CLOCK_STATUS	RST CLK CLOCK STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_PLL_CONTROL	RST CLK PLL CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_HS_CONTROL	RST CLK HS CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_CPU_CLOCK RST CLK CPU CLOCK
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_USB_CLOCK	RST CLK USB CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_ADC_MCO_CLOCK	RST CLK ADC MCO CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_RTC_CLOCK	RST CLK RTC CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_PER_CLOCK RST_CLK PER_CLOCK
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_CAN_CLOCK	RST CLK CAN CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_TIM_CLOCK	RST CLK TIM CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_UART_CLOCK	RST CLK UART CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_SSP_CLOCK	RST CLK SSP CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_ETH_CLOCK	RST CLK ETR CLOCK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_RST_CLK_DMA_DONE_STICK RST_CLK DMA_DONE_STICK
 * @{
 */
...
/** @} */ /* End of group __K1986VE1xI_Periph_RST_CLK_DMA_DONE_STICK */
...
/** @defgroup K1986VE1xI_Periph_DMA DMA
  * @{
  */

/** @defgroup K1986VE1xI_Periph_DMA_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_DMA_Data_Structures */

/** @defgroup K1986VE1xI_Periph_DMA_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_DMA_STATUS	DMA STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_DMA_CFG	DMA CFG
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_DMA_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_DMA */


/** @defgroup K1986VE1xI_Periph_Periph_UART UART
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_UART_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_UART_TypeDef UART_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_UART_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_UART_DR	UART DR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_RSR_ECR	UART RSR ECR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_FR	UART FR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_LCR_H	UART LCR H
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_CR	UART CR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_IFLS	UART IFLS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_IMSC	UART IMSC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_RIS	UART RIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_MIS	UART MIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_ICR	UART ICR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_DMACR	UART DMACR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_UART_RTTCR	UART RTTCR
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_SPI SPI
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_SPI_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_SPI_TypeDef SPI_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_SPI_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_SSP_CR0	SSP CR0
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_CR1	SSP CR1
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_SR	SSP SR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_IMSC	SSP IMSC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_RIS	SSP RIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_MIS	SSP MIS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_SPI_SSPx SPI SSPx
 *  @{
 */
...
/** @defgroup __K1986VE1xI_Periph_SSP_ICR	SSP ICR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_SSP_DMACR	SSP DMACR
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_MIL_STD_1553 MIL_STD_1553
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_Data_Structures Data Structures
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_Defines Defines
  * @{
  */
/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_CONTROL	MIL STD 1553 CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_STATUS	MIL STD 1553 STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_ERROR	MIL STD 1553 ERROR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_MIL_STD_1553_ITEEN	MIL STD 1553 ITEEN
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_POWER POWER
 * @{
 */

/** @defgroup K1986VE1xI_Periph_POWER_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_POWER_Data_Structures */

/** @defgroup K1986VE1xI_Periph_POWER_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_POWER_PVDCS	POWER PVDCS
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_POWER_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_POWER */

/** @defgroup K1986VE1xI_Periph_WWDG WWDG
  * @{
  */

/** @defgroup K1986VE1xI_Periph_WWDG_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_WWDG_Data_Structures */

/** @defgroup K1986VE1xI_Periph_WWDG_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_WWDG_CR	WWDG CR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_WWDG_CFR	WWDG CFR
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_WWDG_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_WWDG */

/** @defgroup K1986VE1xI_Periph_IWDG IWDG
  * @{
  */

/** @defgroup K1986VE1xI_Periph_IWDG_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_IWDG_Data_Structures */

/** @defgroup K1986VE1xI_Periph_IWDG_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_IWDG_SR	IWDG SR
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_IWDG_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_IWDG */


/** @defgroup K1986VE1xI_Periph_TIMER TIMER
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_TIMER_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_TIMER_TypeDef TIMER_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_TIMER_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_TIMER_CNTRL	TIMER CNTRL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_CH_CNTRL	TIMER CH CNTRL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_CH_CNTRL1 TIMER CH CNTRL1
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_TIMER_CH_DTG	TIMER CH DTG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_BRKETR_CNTRL	TIMER BRKETR CNTRL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_STATUS	TIMER STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_IE	TIMER IE
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_DMA_RE	TIMER DMA RE
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_TIMER_CH_CNTRL2	TIMER CH CNTRL2
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_ADC ADC
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ADC_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ADC_TypeDef ADC_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_ADC_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ADC1_CFG	ADC1 CFG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ADC2_CFG	ADC2 CFG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ADC1_RESULT	ADC1 RESULT
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ADC_STASUS	ADC STASUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ADC_TRIM	ADC TRIM
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_DAC DAC
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_DAC_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_DAC_TypeDef DAC_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_DAC_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_DAC_CFG	DAC CFG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_DAC1_DATA	DAC1 DATA
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_DAC2_DATA	DAC2 DATA
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_PORT PORT
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_PORT_Data_Structures Data Structures
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_PORT_TypeDef PORT_TypeDef
  * @{
  */
...
/** @defgroup __K1986VE1xI_Periph_PORT_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_PORT_FUNC	PORT FUNC
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_PORT_PULL	PORT PULL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_PORT_PD	PORT PD
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_PORT_PWR	PORT PWR
  * @{
  */ 
...
/** @defgroup K1986VE1xI_Periph_ARINC429R ARINC429R
  * @{
  */

/** @defgroup K1986VE1xI_Periph_ARINC429R_Data_Structures Data Structures
  * @{
  */
...
/** @defgroup K1986VE1xI_Periph_ARINC429R_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL1 ARINC429R CONTROL1
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL2 ARINC429R CONTROL2
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL3 ARINC429R CONTROL3
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_STATUS1 ARINC429R STATUS1
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_STATUS2 ARINC429R STATUS2
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL4 ARINC429R CONTROL4
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL5 ARINC429R CONTROL5
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CHANNEL ARINC429R CHANNEL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_INTMASK ARINC429R INTMASK
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL8 ARINC429R CONTROL8
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL9 ARINC429R CONTROL9
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL10 ARINC429R CONTROL10
  * @{
  */ 

#define ARINC429R_CONTROL10_R_PAUSE1_Pos            0
#define ARINC429R_CONTROL10_R_PAUSE1_Msk            (0xFFUL << ARINC429R_CONTROL10_R_PAUSE1_Pos)

#define ARINC429R_CONTROL10_R_PAUSE2_Pos            8
#define ARINC429R_CONTROL10_R_PAUSE2_Msk            (0xFFUL << ARINC429R_CONTROL10_R_PAUSE2_Pos)

#define ARINC429R_CONTROL10_R_PAUSE3_Pos            16
#define ARINC429R_CONTROL10_R_PAUSE3_Msk            (0xFFUL << ARINC429R_CONTROL10_R_PAUSE3_Pos)

#define ARINC429R_CONTROL10_R_PAUSE4_Pos            24
#define ARINC429R_CONTROL10_R_PAUSE4_Msk            (0xFFUL << ARINC429R_CONTROL10_R_PAUSE4_Pos)

/** @} */ /* End of group ARINC429R_CONTROL10 */

/** @defgroup __K1986VE1xI_Periph_ARINC429R_CONTROL11 ARINC429R CONTROL11
  * @{
  */ 

#define ARINC429R_CONTROL11_R_PAUSE5_Pos            0
#define ARINC429R_CONTROL11_R_PAUSE5_Msk            (0xFFUL << ARINC429R_CONTROL11_R_PAUSE5_Pos)

#define ARINC429R_CONTROL11_R_PAUSE6_Pos            8
#define ARINC429R_CONTROL11_R_PAUSE6_Msk            (0xFFUL << ARINC429R_CONTROL11_R_PAUSE6_Pos)

#define ARINC429R_CONTROL11_R_PAUSE7_Pos            16
#define ARINC429R_CONTROL11_R_PAUSE7_Msk            (0xFFUL << ARINC429R_CONTROL11_R_PAUSE7_Pos)

#define ARINC429R_CONTROL11_R_PAUSE8_Pos            24
#define ARINC429R_CONTROL11_R_PAUSE8_Msk            (0xFFUL << ARINC429R_CONTROL11_R_PAUSE8_Pos)

/** @} */ /* End of group ARINC429R_CONTROL11 */

/** @} */ /* End of group __K1986VE1xI_Periph_ARINC429R_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_ARINC429R */

/** @defgroup K1986VE1xI_Periph_ARINC429T ARINC429T
  * @{
  */

/** @defgroup K1986VE1xI_Periph_ARINC429T_Data_Structures Data Structures
  * @{
  */
...
/** @defgroup K1986VE1xI_Periph_ARINC429T_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ARINC429T_CONTROL1 ARINC429T CONTROL1
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429T_CONTROL2 ARINC429T CONTROL2
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429T_STATUS ARINC429T STATUS
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429T_CONTROL3 ARINC429T CONTROL3
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429T_CONTROL4 ARINC429T CONTROL4
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ARINC429T_CONTROL5 ARINC429T CONTROL5
  * @{
  */ 

#define ARINC429T_CONTROL5_T_PAUSE1_Pos             0
#define ARINC429T_CONTROL5_T_PAUSE1_Msk             (0xFFUL << ARINC429T_CONTROL5_T_PAUSE1_Pos)

#define ARINC429T_CONTROL5_T_PAUSE2_Pos             8
#define ARINC429T_CONTROL5_T_PAUSE2_Msk             (0xFFUL << ARINC429T_CONTROL5_T_PAUSE2_Pos)

#define ARINC429T_CONTROL5_T_PAUSE3_Pos             16
#define ARINC429T_CONTROL5_T_PAUSE3_Msk             (0xFFUL << ARINC429T_CONTROL5_T_PAUSE3_Pos)

#define ARINC429T_CONTROL5_T_PAUSE4_Pos             24
#define ARINC429T_CONTROL5_T_PAUSE4_Msk             (0xFFUL << ARINC429T_CONTROL5_T_PAUSE4_Pos)

/** @} */ /* End of group Periph_ARINC429T_CONTROL5 */

/** @} */ /* End of group __K1986VE1xI_Periph_ARINC429T_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_ARINC429T */

/** @defgroup K1986VE1xI_Periph_BKP BKP
  * @{
  */

/** @defgroup K1986VE1xI_Periph_BKP_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_BKP_Data_Structures */

/** @defgroup K1986VE1xI_Periph_BKP_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_BKP_REG_0E	BKP REG 0E
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_BKP_REG_0F	BKP REG 0F
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_BKP_RTC_CS	BKP RTC CS
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_BKP_Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_BKP */

/** @defgroup K1986VE1xI_Periph_EBC EBC
 *  @{
 */

/** @defgroup K1986VE1xI_Periph_EBC_Data_structures Data Structures
 *  @{
 */
...
/** @} */ /* End of groupe K1986VE1xI_Periph_EBC_Data_structures Data Structures */

/** @defgroup __K1986VE1xI_K1986VE1xI_Periph_EBC_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_EBC_NAND_CYCLES	EBC NAND CYCLES
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_EBC_CONTROL	EBC CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_EBC_RAM_CYCLESx	EBC RAM CYCLESx
  * @{
  */ 
...
/** @} */ /* End of groupe K1986VE1xI_Periph_EBC_Defines Defines */

/** @} */ /* End of groupe __K1986VE1xI_Periph_EBC EBC */

/** @defgroup K1986VE1xI_Periph_ETHERNET ETHERNET
  * @{
  */

/** @defgroup K1986VE1xI_Periph_Data_Structures Data Structures
  * @{
  */
...
/** @} */ /* End of group __K1986VE1xI_Periph_Data_Structures */

/** @defgroup K1986VE1xI_Periph_ETHERNET_Defines Defines
  * @{
  */

/** @defgroup __K1986VE1xI_Periph_ETH_G_CFGl	ETH G CFGl
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_G_CFGh	ETH G CFGh
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_X_CFG	ETH X CFG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_R_CFG	ETH R CFG
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_IMR	ETH IMR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_IFR	ETH IFR
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_STAT	ETH STAT
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_MDIO_CTRL	ETH MDIO CTRL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_PHY_CONTROL	ETH PHY CONTROL
  * @{
  */ 
...
/** @defgroup __K1986VE1xI_Periph_ETH_PHY_STATUS	ETH PHY STATUS
  * @{
  */ 
...
/** @} */ /* End of group __K1986VE1xI_Periph_ETHERNET Defines */

/** @} */ /* End of group __K1986VE1xI_Periph_ETHERNET */

/** @} */ /* End of group __K1986VE1xI_Peripheral_Units */
...
/** @} */ /* End of group K1986VE1xI_Peripheral K1986VE1xI Peripheral */

/** @} */ /* End of group K1986VE1xI */
...
#endif /* __K1986VE1xI_H */

/*
*
* END OF FILE K1986VE1xI.h */
