...
/** @addtogroup IWDG_INDEPENDENT_MDR32F9Q2I IWDG_Independent
  * @{
  */

/* Private define ------------------------------------------------------------*/
#define LED1_PIN        PORT_Pin_0
#define LED1_PORT       MDR_PORTC
#define LED1_PORT_PCLK  RST_CLK_PCLK_PORTC
...
/** @} */ /* End of group IWDG_INDEPENDENT_MDR32F9Q2I */
