...
/** @addtogroup DMA_UART_RAM_MDR32F9Q2I DMA_UART_RAM
  * @{
  */
...
int main(void)
{
    ...
    RST_CLK_PCLKcmd((RST_CLK_PCLK_RST_CLK | RST_CLK_PCLK_PORTF | RST_CLK_PCLK_PORTB |
                RST_CLK_PCLK_UART1 | RST_CLK_PCLK_UART2 | RST_CLK_PCLK_DMA), ENABLE);
...
/** @} */ /* End of group DMA_UART_RAM_MDR32F9Q2I */
