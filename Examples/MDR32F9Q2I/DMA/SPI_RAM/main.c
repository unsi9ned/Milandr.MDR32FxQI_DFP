...
/** @addtogroup DMA_SPI_RAM_MDR32F9Q2I DMA_SPI_RAM
  * @{
  */
...
int main(void)
{
    ...
    RST_CLK_PCLKcmd((RST_CLK_PCLK_RST_CLK | RST_CLK_PCLK_PORTF | RST_CLK_PCLK_PORTD |
                RST_CLK_PCLK_SSP1 | RST_CLK_PCLK_SSP2 | RST_CLK_PCLK_DMA), ENABLE);
...
/** @} */ /* End of group DMA_SPI_RAM_MDR32F9Q2I */
