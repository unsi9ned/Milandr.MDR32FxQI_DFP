...
This example shows how to use BKP module low-power functions.
That action includes the following steps:
    - Configure PORTC line 0 as output LED;
    - Configure PORTB line 10 as input EXT_INT2;
    - Enable EXT_INT2 interrupt;
    - Enter Stop mode;
    - Turn on/off LED when EXT_INT2 interrupt occurs.
