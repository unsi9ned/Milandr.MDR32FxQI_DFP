  /**
  @addtogroup CAN_LoopBack_Polling_MDR32F9Q2I CAN_LoopBack_Polling for MDR32F9Q2I evaluation board
  @latexonly
  @verbatim
  ...
  * @version V2.0.2
  * @date    08/11/2024
  * @brief   Description of the CAN_LoopBack_Polling Example.
  ******************************************************************************
...
If CONFIG_CAN_PINS defined, PA7 and PA6 pins are configured as CAN1 RX and TX.
