...
/** @addtogroup TIMER_5PWM_Output_MDR32F1QI TIMER_5PWM_Output
  * @{
  */
...
int main(void)
{
    ...
    PORT_InitStructure.PORT_Pin   = (PORT_Pin_6 | PORT_Pin_7 | PORT_Pin_8
...
/** @} */ /* End of group TIMER_5PWM_Output_MDR32F1QI */
